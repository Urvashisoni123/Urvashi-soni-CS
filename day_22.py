...
ttk.Button(app, text='Predict', command=prediction,font=('Ariel',20)).grid(row=4, column=0, columnspan=2)

result.set('0')
ttk.Label(app, textvariable=result, pady=15, font=('Ariel',20)).grid(row=5,column=0,columnspan=2)
